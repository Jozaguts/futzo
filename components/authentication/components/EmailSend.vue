  ...
  <div>
    <v-card-item class="d-flex justify-center align-center">
      ...
      <v-card-subtitle class="text-center verify-card-subtitle">
        Revisa tu bandeja de entrada y sigue <br> las instrucciones para restablecer tu contraseña
      </v-card-subtitle>
    </v-card-item>
      ...
      <div class="verify-card-options-container d-flex  justify-center align-center flex-column ">
        ...
        <div class="d-flex align-center">
          <v-badge :content="counter" location="bottom right" :offset-x="-4">
            <v-btn block :disabled="!!counter || forgotPasswordState.isFetching" :loading="forgotPasswordState.isFetching" @click="resendCode">Reenviar</v-btn>
          </v-badge>
        </div>
      </div>
      <div
