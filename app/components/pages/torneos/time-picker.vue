...
const selectDate = (direction: string) => {
  direction === "from"
    ? fromBtnRf.value.selectDate()
    : toBtnRf.value.selectDate();
};
</script>
    ...
    <v-col>
      ...
      >
        ...
        <template #action-buttons>
          <p class="calendar-custom-btn" @click="() => selectDate('from')">
            Aceptar
          </p>
        </template>
      </vue-date-picker>
    ...
    <v-col>
      ...
      >
        <template #dp-input="{ value }">
          ...
          >
            <template #prepend-inner
              ><span class="text-medium-emphasis">Hasta</span></template
            >
          </v-text-field>
        </template>
        <template #action-preview></template>
        <template #action-buttons>
          <p class="calendar-custom-btn" @click="() => selectDate('to')">
            Aceptar
          </p>
        </template>
      </vue-date-picker>
