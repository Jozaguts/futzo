<script lang="ts" setup>
  ...
  const { fields, handleSubmit, resetForm } = useSchemas('create-category')
        ...
        <v-dialog max-width="400" v-model="dialog" activator="parent">
          <v-card class="card-in-dialog">
                  ...
                  <v-row>
                    ...
                    <v-col cols="12">
                      <v-select
                        ...
                        label="Genero"
                        :items="[
                          { id: 'male', name: 'Varonil' },
                          { id: 'female', name: 'Femenil' },
                        ]"
                        item-title="name"
                        item-value="id"
                      >
            ...
            <v-card-actions class="d-flex justify-center align-center">
              <v-btn variant="elevated" color="primary" block @click="createCategory"> Agregar categoría </v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
      </v-btn>
