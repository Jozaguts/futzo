...
<template>
  <v-card v-if="showForgotPassword" class="pa-2" max-width="100%" min-width="500" elevation="0" color="background">
    ...
    <div class="forgot-password-steps-container">
      ...
      <span
        class="step"
        :class="[
          forgotPasswordState.step === 'confirm-password' ? 'bg-primary' : '',
          forgotPasswordState.step === 'email-sent' ? 'bg-primary' : '',
        ]"
      ></span>
    </div>
  </v-card>
