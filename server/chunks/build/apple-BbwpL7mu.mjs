...
const apple = { render() {
  return h(NuxtIcon, { icon: { render }, name: "apple" });
} };

export { apple as default, render };
//# sourceMappingURL=apple-BbwpL7mu.mjs.map
