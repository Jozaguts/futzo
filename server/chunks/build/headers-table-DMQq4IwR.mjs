import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, provide, inject, ref, watch, watchEffect, nextTick, capitalize } from 'vue';
import { p as propsFactory, aS as IconValue, aT as makeBorderProps, q as makeComponentProps, aU as makeDensityProps, F as makeElevationProps, E as makeRoundedProps, aV as makeSizeProps, ai as makeTagProps, aj as makeThemeProps, aW as makeVariantProps, L as genericComponent, X as useProxiedModel, aQ as useLocale, J as useRtl, ak as provideTheme, aw as useDisplay, a9 as provideDefaults, w as useResizeObserver, K as createRange, x as useRender, e as VBtn, ad as VSelect, aX as defineFunctionalComponent, v as convertToUnit, aZ as makeDisplayProps, a_ as makeLoaderProps, a$ as useLoader, T as useBackgroundColor, b0 as LoaderSlot, at as VCheckboxBtn, b1 as EventProp, aN as getObjectValueByPath, ab as VDivider, aM as isOn, aO as getCurrentInstance, a4 as deepEqual, aP as wrapInArray, aR as isEmpty, Q as keyValues, a5 as VIcon, ag as VChip, t as clamp, b2 as getPropertyFromItem, aY as consoleError } from './server.mjs';
import { m as makeVTableProps, V as VTable } from './VTable-Bam0vwJv.mjs';
import { m as makeFilterProps, u as useFilter } from './VDialog-CDis8WGv.mjs';
...
export { VDataTable as V, VPagination as a, getHeaders as g };
//# sourceMappingURL=headers-table-DMQq4IwR.mjs.map
