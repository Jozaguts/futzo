import { createVNode, toRef, shallowRef, computed, ref, watchEffect, mergeProps, Fragment, defineComponent, useSSRContext, withCtx, renderSlot, watch, unref, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import { p as propsFactory, q as makeComponentProps, ai as makeTagProps, L as genericComponent, x as useRender, aT as makeBorderProps, F as makeElevationProps, E as makeRoundedProps, aj as makeThemeProps, T as useBackgroundColor, bt as useBorder, N as useElevation, S as useRounded, ak as provideTheme, J as useRtl, a9 as provideDefaults, m as VImg, bI as VDefaultsProvider, v as convertToUnit, bM as VExpandTransition, X as useProxiedModel, bN as useToggleScope, b5 as useSsrBoot, bO as makeRouterProps, bP as useLink, O as useTextColor, aS as IconValue, aU as makeDensityProps, bc as useDensity, a5 as VIcon, t as clamp, ao as useRoute$1, j as useAuthStore } from './server.mjs';
import { m as makeLayoutItemProps, u as useLayoutItem } from './layout-BllP2C0g.mjs';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/page-layout/index.vue");
...
//# sourceMappingURL=app-bar-vuUpVYZ5.mjs.map
