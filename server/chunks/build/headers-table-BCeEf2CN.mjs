import { p as propsFactory, aJ as IconValue, bg as makeBorderProps, m as makeComponentProps, K as makeDensityProps, a9 as makeElevationProps, a8 as makeRoundedProps, a$ as makeSizeProps, n as makeTagProps, o as makeThemeProps, bh as makeVariantProps, q as genericComponent, I as useProxiedModel, t as useLocale, s as useRtl, r as provideTheme, b0 as useDisplay, P as provideDefaults, $ as useResizeObserver, ab as createRange, w as useRender, ax as VSelect, bi as defineFunctionalComponent, C as convertToUnit, bk as makeDisplayProps, bl as makeLoaderProps, aP as useLoader, N as useBackgroundColor, aS as LoaderSlot, aW as VCheckboxBtn, bn as EventProp, bc as getObjectValueByPath, av as VDivider, bb as isOn, bd as getCurrentInstance, ap as deepEqual, be as wrapInArray, bf as isEmpty, af as keyValues, aq as VIcon, bm as VChip, T as VAvatar, _ as __nuxt_component_0$1, Z as clamp, aB as getPropertyFromItem, bj as consoleError } from './server.mjs';
import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, toRefs, useSSRContext, provide, inject, ref, watch, nextTick, watchEffect, capitalize, defineComponent, mergeModels, useModel, createSlots, withCtx, renderSlot, openBlock, createBlock, createCommentVNode } from 'vue';
...
import { m as makeVTableProps, V as VTable, a as VTooltip } from './VTooltip-DTrZ32iS.mjs';
...
//# sourceMappingURL=headers-table-BCeEf2CN.mjs.map
