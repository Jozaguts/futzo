import { useSSRContext, defineComponent, withCtx, createVNode, mergeProps, unref, createTextVNode } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { aw as useTournamentStore, f as _export_sfc, i as useRouter$1 } from './server.mjs';
...
import { g as getHeaders, _ as _sfc_main$9 } from './headers-table-Dwx7nOYp.mjs';
import { V as VBtn } from './VBtn-sH8DNEZb.mjs';
import { V as VSheet } from './useSchemas-CkEHQvYm.mjs';
import { _ as _sfc_main$8 } from './index-BxmXL1hM.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!unref(noTournaments)) {
        _push(ssrRenderComponent(_sfc_main$9, mergeProps({
          ...
          "onUpdate:pagination": ($event) => unref(useTournamentStore)().loadTournaments(),
...
const TournamentTable = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-73ffb4ac"]]);
const _sfc_main$2 = {};
...
//# sourceMappingURL=index-C2d6HebX.mjs.map
