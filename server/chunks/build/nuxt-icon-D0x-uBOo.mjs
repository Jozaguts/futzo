    ...
    async function getIcon() {
      try {
        const iconsImport = /* @__PURE__ */ Object.assign({
          ...
          "/assets/icons/calendar-arrow-left.svg": () => import('./calendar-arrow-left-DZXmdVSo.mjs').then((m) => m["default"]),
          "/assets/icons/calendar-arrow-right.svg": () => import('./calendar-arrow-right-CjfVmCYe.mjs').then((m) => m["default"]),
          "/assets/icons/calendar-white.svg": () => import('./calendar-white-GblAqnhL.mjs').then((m) => m["default"]),
          ...
          "/assets/icons/content.svg": () => import('./content-Dc_F6yNe.mjs').then((m) => m["default"]),
          ...
          "/assets/icons/logo-22.svg": () => import('./logo-22-DZm9OMbF.mjs').then((m) => m["default"]),
          ...
          "/assets/icons/polygon.svg": () => import('./polygon-DrSjn0j2.mjs').then((m) => m["default"]),
          "/assets/icons/roles.svg": () => import('./roles-OpbZyDWa.mjs').then((m) => m["default"]),
...
//# sourceMappingURL=nuxt-icon-D0x-uBOo.mjs.map
