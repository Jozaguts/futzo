import { shallowRef, ref, computed, watch, createVNode, inject, withDirectives, resolveDirective, vShow, mergeProps, Fragment, useSSRContext, defineComponent as defineComponent$1, withCtx, toRef, provide, createTextVNode, toDisplayString, unref, resolveComponent, openBlock, createBlock, createCommentVNode } from 'vue';
import { p as propsFactory, q as makeComponentProps, r as defineComponent, t as clamp, v as convertToUnit, w as useResizeObserver, x as useRender, e as VBtn, E as makeRoundedProps, F as makeElevationProps, L as genericComponent, M as Ripple, J as useRtl, N as useElevation, O as useTextColor, P as VScaleTransition, S as useRounded, T as useBackgroundColor, U as makeFocusProps, W as makeVInputProps, X as useProxiedModel, Y as useFocus, Z as VInput, $ as VLabel, a0 as SUPPORTS_EYE_DROPPER, a1 as HSVtoCSS, a2 as parseColor, R as RGBtoHSV, a3 as RGBtoCSS, a4 as deepEqual, a5 as VIcon, a6 as getContrast, a7 as omit, a8 as consoleWarn, a9 as provideDefaults, aa as useTeamStore, s as storeToRefs, y as getEventCoordinates, H as HSVtoHex, z as has, A as HSVtoRGB, B as HSVtoHSL, C as HSLtoHSV, I as getDecimals, K as createRange, a as VCardItem, ab as VDivider, V as VCard, ac as useTournamentStore, d as VTextField, ad as VSelect, ae as VListItem, af as VListItemTitle, G as Gl, c as VCardText, l as VAvatar, ag as VChip, D as HexToHSV, _ as _export_sfc, o as __nuxt_component_1$1, Q as keyValues } from './server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderAttrs } from 'vue/server-renderer';
import { _ as _sfc_main$2$1, a as _sfc_main$i } from './app-bar-vuUpVYZ5.mjs';
import { S as SearchInput } from './SearchInput-Czy3jqei.mjs';
import { _ as _sfc_main$1$1, u as useCategoryStore, a as _sfc_main$j } from './drag-drop-image-CQcP1rQW.mjs';
import { m as makeVSheetProps, V as VSheet, u as useSchemas } from './useSchemas-DRmKLgdK.mjs';
import _sfc_main$l from './nuxt-icon-D0x-uBOo.mjs';
import { _ as _sfc_main$k, a as __nuxt_component_0 } from './stepper-dot-26uQjk4Q.mjs';
...
const AppBarSecondaryBtn = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-cd18fc53"]]);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_icon = _sfc_main$l;
      _push(`<!--[-->`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VColorPicker, {
                    ...
                    position: "absolute",
                    mode: "hexa",
                    "onUpdate:modelValue": colorHandler
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const updateColorHandler = (color, isHomeColor, type) => {
      if (isHomeColor) {
        colors2.value.home[type] = color;
        fields.colors.fieldValue = { ...colors2.value };
      } else {
        colors2.value.away[type] = color;
        fields.colors.fieldValue = { ...colors2.value };
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--03b443c8": unref(colors2).home.primary,
        "--4939a30e": unref(colors2).home.secondary,
        "--dd5165aa": unref(colors2).away.primary,
        "--5468eb46": unref(colors2).away.secondary
      } };
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, { cols: "12" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VRow, { "no-gutters": "" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VCol, { cols: "6" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="color-pickers-container"${_scopeId7}><div class="color-pickers-container__label"${_scopeId7}><span class="text-body-2"${_scopeId7}>Local</span></div><div class="color-picker-items-container"${_scopeId7}><div class="color-picker-items-container__item home primary"${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_sfc_main$8, {
                                                  onUpdateValue: ($event) => updateColorHandler($event, true, "primary")
                                                }, null, _parent8, _scopeId7));
                                                _push8(`</div><div class="color-picker-items-container__item home secondary"${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_sfc_main$8, {
                                                  onUpdateValue: ($event) => updateColorHandler($event, true, "secondary")
                                                }, null, _parent8, _scopeId7));
                                                _push8(`</div></div><div${_scopeId7}><small class="text-error text-caption"${_scopeId7}>${ssrInterpolate(unref(fields).colors.fieldPropsValue["error-messages"][0])}</small></div></div>`);
                                              } else {
                                                return [
                                                  createVNode("div", { class: "color-pickers-container" }, [
                                                    ...
                                                    createVNode("div", { class: "color-picker-items-container" }, [
                                                      createVNode("div", { class: "color-picker-items-container__item home primary" }, [
                                                        createVNode(_sfc_main$8, {
                                                          onUpdateValue: ($event) => updateColorHandler($event, true, "primary")
                                                        }, null, 8, ["onUpdateValue"])
                                                      ]),
                                                      createVNode("div", { class: "color-picker-items-container__item home secondary" }, [
                                                        createVNode(_sfc_main$8, {
                                                          onUpdateValue: ($event) => updateColorHandler($event, true, "secondary")
                                                        }, null, 8, ["onUpdateValue"])
                                                      ])
                                                    ...
                                                    createVNode("div", null, [
                                                      createVNode("small", { class: "text-error text-caption" }, toDisplayString(unref(fields).colors.fieldPropsValue["error-messages"][0]), 1)
                                                    ])
                                                  ])
                                                ];
                                              }
                                          ...
                                          _push7(ssrRenderComponent(VCol, { cols: "6" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="color-pickers-container"${_scopeId7}><div class="color-pickers-container__label"${_scopeId7}><span class="text-body-2"${_scopeId7}>Visitante</span></div><div class="color-picker-items-container"${_scopeId7}><div class="color-picker-items-container__item away primary"${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_sfc_main$8, {
                                                  onUpdateValue: ($event) => updateColorHandler($event, false, "primary")
                                                }, null, _parent8, _scopeId7));
                                                _push8(`</div><div class="color-picker-items-container__item away secondary"${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_sfc_main$8, {
                                                  onUpdateValue: ($event) => updateColorHandler($event, false, "secondary")
                                                }, null, _parent8, _scopeId7));
                                                _push8(`</div></div><div${_scopeId7}><small class="text-error text-caption"${_scopeId7}>${ssrInterpolate(unref(fields).colors.fieldPropsValue["error-messages"][0])}</small></div></div>`);
                                              } else {
                                                return [
                                                  createVNode("div", { class: "color-pickers-container" }, [
                                                    ...
                                                    createVNode("div", { class: "color-picker-items-container" }, [
                                                      createVNode("div", { class: "color-picker-items-container__item away primary" }, [
                                                        createVNode(_sfc_main$8, {
                                                          onUpdateValue: ($event) => updateColorHandler($event, false, "primary")
                                                        }, null, 8, ["onUpdateValue"])
                                                      ]),
                                                      createVNode("div", { class: "color-picker-items-container__item away secondary" }, [
                                                        createVNode(_sfc_main$8, {
                                                          onUpdateValue: ($event) => updateColorHandler($event, false, "secondary")
                                                        }, null, 8, ["onUpdateValue"])
                                                      ])
                  ...
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<span class="${ssrRenderClass([
                          unref(fields).avatar.fieldPropsValue["error-messages"][0] ? "ml-2" : "",
                          "text-error text-caption"
                        ])}"${_scopeId3}>${ssrInterpolate((_a2 = unref(fields).avatar.fieldPropsValue["error-messages"][0]) != null ? _a2 : "")}</span>`);
                      } else {
                        return [
                          createVNode(_sfc_main$j, {
                            ref_key: "dragDropImageRef",
                          ...
                          }, toDisplayString((_b = unref(fields).avatar.fieldPropsValue["error-messages"][0]) != null ? _b : ""), 3)
                        ];
                      }
                    }),
                    _: 1
                    ...
                    createVNode(VCol, {
                      ...
                      default: withCtx(() => {
                        ...
                        return [
                          ...
                          }, toDisplayString((_a2 = unref(fields).avatar.fieldPropsValue["error-messages"][0]) != null ? _a2 : ""), 3)
                        ];
                      }),
                      _: 1
                    })
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "steps-container" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$k, {
        active: unref(steps).current === "createTeam",
        completed: unref(steps).completed.includes("createTeam"),
        label: "Crear un equipo"
      }, null, _parent));
      _push(ssrRenderComponent(VDivider, null, null, _parent));
      _push(ssrRenderComponent(_sfc_main$k, {
        active: unref(steps).current === "createDt",
        completed: unref(steps).completed.includes("createDt"),
        label: "Crear el DT"
      }, null, _parent));
      _push(ssrRenderComponent(VDivider, null, null, _parent));
      _push(ssrRenderComponent(_sfc_main$k, {
        active: unref(steps).current === "createOwner",
        completed: unref(steps).completed.includes("createOwner"),
        label: "Crea el due\xF1o"
      }, null, _parent));
      _push(`</div>`);
    };
  }
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/equipos/stepper/step-indicator.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PerfectScrollbar, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                  ...
                  _push3(ssrRenderComponent(_component_transition_slide, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          unref(steps).current === "createTeam" ? (openBlock(), createBlock(_sfc_main$7, {
                            ref_key: "stepRef",
                            ref: stepRef,
                            key: unref(steps).current
                          })) : createCommentVNode("", true),
                          unref(steps).current === "createDt" ? (openBlock(), createBlock(_sfc_main$6, {
                            ref_key: "stepRef",
                            ref: stepRef,
                            key: unref(steps).current
                          })) : createCommentVNode("", true),
                          unref(steps).current === "createOwner" ? (openBlock(), createBlock(_sfc_main$5, {
                            ref_key: "stepRef",
                            ref: stepRef,
                            key: unref(steps).current
                          })) : createCommentVNode("", true)
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(noTeams)) {
        _push(ssrRenderComponent(VCard, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(VCardText, { class: "fill-height" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VDataTable, {
                      ...
                      [`item.index`]: withCtx(({ item, index }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                      ...
                      [`item.name`]: withCtx(({ item, index }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                      ...
                      bottom: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(VPagination, {
                            ...
                            "onUpdate:modelValue": [($event) => unref(pagination).page = $event, paginationHandler],
                            length: unref(pagination).total
                          }, {
                            prev: withCtx((props, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                            ...
                            next: withCtx((props, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VBtn, {
                                  onClick: props.onClick,
                                  disabled: props.disabled,
                          ...
                          return [
                            ...
                            createVNode(VPagination, {
                              ...
                              _: 1
                            }, 8, ["modelValue", "onUpdate:modelValue", "length"])
                          ];
                        }
                      }),
                      _: 2
                    ...
                    return [
                      createVNode(VDataTable, {
                        ...
                        [`item.index`]: withCtx(({ item, index }) => [
                          createTextVNode(toDisplayString(index + 1), 1)
                        ]),
                        [`item.name`]: withCtx(({ item, index }) => [
                          createVNode(VAvatar, {
                            image: item.image
                          }, null, 8, ["image"]),
                          createTextVNode(" " + toDisplayString(item.name), 1)
              ...
              return [
                createVNode(VCardText, { class: "fill-height" }, {
                  default: withCtx(() => [
                    createVNode(VDataTable, {
                      class: "border-sm fill-height futzo-rounded teams-table",
                      style: { "max-height": "calc(100% - 2rem)", "border-color": "#eaecf0 !important" },
...
//# sourceMappingURL=index-CaQBZR-a.mjs.map
