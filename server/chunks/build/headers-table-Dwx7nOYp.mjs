import { p as propsFactory, a$ as IconValue, b0 as makeBorderProps, m as makeComponentProps, K as makeDensityProps, a9 as makeElevationProps, a8 as makeRoundedProps, b1 as makeSizeProps, n as makeTagProps, o as makeThemeProps, b2 as makeVariantProps, q as genericComponent, I as useProxiedModel, t as useLocale, s as useRtl, r as provideTheme, b3 as useDisplay, P as provideDefaults, $ as useResizeObserver, ab as createRange, w as useRender, ax as VSelect, b4 as defineFunctionalComponent, C as convertToUnit, b6 as makeDisplayProps, b7 as makeLoaderProps, b8 as useLoader, N as useBackgroundColor, b9 as LoaderSlot, aJ as VCheckboxBtn, bb as EventProp, aX as getObjectValueByPath, av as VDivider, T as VAvatar, ba as VChip, aW as isOn, aY as getCurrentInstance, ap as deepEqual, aZ as wrapInArray, a_ as isEmpty, af as keyValues, aq as VIcon, _ as __nuxt_component_1$1, Z as clamp, aB as getPropertyFromItem, b5 as consoleError } from './server.mjs';
import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, toRefs, defineComponent, mergeModels, useModel, createSlots, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, useSSRContext, provide, inject, ref, watch, nextTick, watchEffect, capitalize } from 'vue';
...
import { m as makeVTableProps, b as makeFilterProps, u as useFilter, V as VTable, c as VTooltip } from './app-bar-4n5zyiNx.mjs';
          ...
          if (_push2) {
            ...
            if (__props.showFooter) {
              _push2(ssrRenderComponent(VPagination, {
                ...
                "onUpdate:modelValue": [($event) => pagination.value.page = $event, ($event) => _ctx.$emit("update:pagination", { ...pagination.value, page: $event })],
                length: pagination.value.total,
                start: "1"
              }, {
...
//# sourceMappingURL=headers-table-Dwx7nOYp.mjs.map
