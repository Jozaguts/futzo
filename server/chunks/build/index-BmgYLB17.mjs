...
import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, defineComponent, unref, withCtx, openBlock, createBlock, useSSRContext, provide, inject, ref, watch, watchEffect, nextTick, capitalize } from 'vue';
import { B as propsFactory, I as IconValue, aa as makeBorderProps, C as makeComponentProps, D as makeDensityProps, F as makeElevationProps, K as makeRoundedProps, ab as makeSizeProps, L as makeTagProps, M as makeThemeProps, N as makeVariantProps, O as genericComponent, P as useProxiedModel, $ as useLocale, ac as useRtl, Q as provideTheme, ad as useDisplay, ae as provideDefaults, af as useResizeObserver, ag as createRange, ah as useRender, e as VBtn, k as VSelect, aj as defineFunctionalComponent, ak as convertToUnit, am as makeDisplayProps, an as makeLoaderProps, ao as useLoader, ap as useBackgroundColor, aq as LoaderSlot, ar as VCheckboxBtn, as as EventProp, a4 as getObjectValueByPath, au as VDivider, av as useTheme, s as storeToRefs, m as useTournamentStore, V as VCard, a as VCardItem, b as VCardTitle, c as VCardText, l as VChip, a3 as isOn, a5 as getCurrentInstance, a6 as deepEqual, a8 as wrapInArray, a9 as isEmpty, ai as keyValues, p as VIcon, _ as _export_sfc, h as useRouter$1, a7 as clamp, at as getPropertyFromItem, al as consoleError } from './server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { _ as _sfc_main$2 } from './Dialog-BprttqFB.mjs';
import { V as VContainer } from './VContainer-BlVN2X13.mjs';
import { V as VRow, a as VCol } from './VRow-B-D5uMI5.mjs';
import { V as VTabs, a as VTab } from './VTabs-CS7OIIzr.mjs';
import { m as makeVTableProps, V as VTable } from './VTable-J0tGGw3A.mjs';
import { m as makeFilterProps, u as useFilter } from './VAutocomplete-IMrjYE8Q.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/liga/NoTournamentsSvg.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const NoTournamentsSvg = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    computed(() => tournaments.value.length > 0);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--68d45de7": unref(backgroundColor)
      } };
                      ...
                      if (_push4) {
                        if (!unref(tournaments).length) {
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VCardTitle, null, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(` No hay torneos a\xFAn `);
                                          } else {
                                            return [
                                              createTextVNode(" No hay torneos a\xFAn ")
                                            ];
                                          }
                                        }),
                                        _: 1
                                      ...
                                      _push6(ssrRenderComponent(VCardText, null, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(NoTournamentsSvg, null, null, _parent7, _scopeId6));
                                          } else {
                                            return [
                                      ...
                                      _push6(ssrRenderComponent(VCardTitle, { class: "text-body-2" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(` Crea un torneo para verlo aqu\xED. `);
                                          } else {
                                            return [
                                              createTextVNode(" Crea un torneo para verlo aqu\xED. ")
                                            ];
                                          }
                                        }),
                                        _: 1
                                      ...
                                      return [
                                        ...
                                        createVNode(VCardTitle, { class: "text-body-2" }, {
                                          default: withCtx(() => [
                                            createTextVNode(" Crea un torneo para verlo aqu\xED. ")
                                          ]),
                                          _: 1
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VCardTitle, { class: "mb-4" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VTabs, null, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(VTab, {
                                              value: "1",
                                ...
                                _push5(ssrRenderComponent(VCardText, { class: "fill-height" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VDataTable, {
                                        ...
                                        "header.data-table-select": withCtx(({
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(VCheckboxBtn, {
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(VChip, {
                                              ...
                                              default: withCtx((_6, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.status)}`);
                                                } else {
                                                  return [
                                        ...
                                        bottom: withCtx((props, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(VDivider, null, null, _parent7, _scopeId6));
                                            _push7(ssrRenderComponent(VPagination, {
                                              ...
                                              prev: withCtx((props2, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VBtn, {
                                                    ...
                                                    prepend: withCtx((_6, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(ssrRenderComponent(_component_nuxt_icon, {
                                                          name: "arrow-left",
                                                          filled: ""
                                              ...
                                              next: withCtx((props2, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VBtn, {
                                                    onClick: props2.onClick,
                                                    disabled: props2.disabled,
                                                    ...
                                                    append: withCtx((_6, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(ssrRenderComponent(_component_nuxt_icon, {
                                                          name: "arrow-right",
                                                          filled: ""
                                ...
                                return [
                                  createVNode(VCardTitle, { class: "mb-4" }, {
                                    default: withCtx(() => [
                                      createVNode(VTabs, null, {
                                        default: withCtx(() => [
                                          createVNode(VTab, {
                        ...
                        return [
                          !unref(tournaments).length ? (openBlock(), createBlock(VCard, {
                            key: 0,
                            rounded: "",
                            elevation: "2",
                            height: "100%",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/liga/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BmgYLB17.mjs.map
