...
const useToast = () => {
  ...
  const toast = (type, msg, description) => {
    return $toast.custom(markRaw(_sfc_main$3), {
      componentProps: {
        msg,
        description,
  ...
  const reSendCode = (param, type) => {
    ...
    client(`api/v1/verify-code/resend?${type}=${param}`).then(() => {
      ...
      toast(
        ...
        ((_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.message) ?? "Ha ocurrido un error al intentar reenviar tu código de verificación. Por favor, intenta nuevamente más tarde."
      );
    });
  };
  return {
...
const _routes = [
  {
    ...
    component: () => import('./callback-9YtwA4fu.mjs')
  },
  {
    name: "bienvenido",
    path: "/bienvenido",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./bienvenido-vbhN9Rh7.mjs')
  },
  {
    name: "configuracion",
    path: "/configuracion",
    component: () => import('./configuracion-T5-7aZ9a.mjs')
  },
  {
    name: "equipos-equipo",
    path: "/equipos/:equipo()",
  ...
  },
  {
    name: "equipos",
    path: "/equipos",
    component: () => import('./index-CNGF-49w.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C7jfs09A.mjs')
  },
  {
    name: "jugadores",
    path: "/jugadores",
    component: () => import('./index-DUiMNhwf.mjs')
  },
  {
    name: "legales",
    path: "/legales",
    component: () => import('./legales-CeuVn4ai.mjs')
  },
  {
    name: "locaciones",
    path: "/locaciones",
    component: () => import('./index-EaUJeM8m.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./login-Cn60khsN.mjs')
  },
  {
    name: "politica-de-privacidad",
    path: "/politica-de-privacidad",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./politica-de-privacidad-3wOwzc5R.mjs')
  },
  {
    name: "terminos-de-servicio",
    path: "/terminos-de-servicio",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./terminos-de-servicio-C_qzklFP.mjs')
  },
  {
    name: "torneos-torneo-calendario",
    path: "/torneos/:torneo()/calendario",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./calendario-DvRJJomr.mjs')
  },
  {
    name: "torneos-torneo",
    path: "/torneos/:torneo()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-eTvK4lz-.mjs')
  },
  {
    name: "torneos",
    path: "/torneos",
    component: () => import('./index-F2t4zRzb.mjs')
  },
  {
    name: "verificar",
    path: "/verificar",
    meta: __nuxt_page_meta || {},
    component: () => import('./verificar-C0VrSAKH.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-DcQOBq-6.mjs')
};
...
const layouts = {
  blank: defineAsyncComponent(() => import('./blank-DoV4TXHF.mjs')),
  default: defineAsyncComponent(() => import('./default-Dk9HCL9b.mjs'))
};
...
export { useResizeObserver as $, useSsrBoot as A, useLazy as B, convertToUnit as C, omit as D, useTextColor as E, forwardRefs as F, animate as G, standardEasing as H, useProxiedModel as I, makeVSlideGroupProps as J, makeDensityProps as K, useDensity as L, MaybeTransition as M, useBackgroundColor as N, useScopeId as O, provideDefaults as P, VSlideGroup as Q, isObject as R, useAuthStore as S, VAvatar as T, VImg as U, VCard as V, VCardSubtitle as W, Gl as X, defineComponent as Y, clamp as Z, __nuxt_component_0$1 as _, useRequestURL as a, makeSizeProps as a$, getEventCoordinates as a0, HSVtoHex as a1, has as a2, HSVtoRGB as a3, HSVtoHSL as a4, RGBtoHSV as a5, HSLtoHSV as a6, HexToHSV as a7, makeRoundedProps as a8, makeElevationProps as a9, getUid as aA, getPropertyFromItem as aB, useDashboardStore as aC, useRoute$1 as aD, usePlayerStore as aE, useCategoryStore as aF, usePositionsStore as aG, makeGroupProps as aH, VExpandTransition as aI, IconValue as aJ, makeDimensionProps as aK, useDimension as aL, VDefaultsProvider as aM, pick$1 as aN, makeVSelectionControlProps as aO, useLoader as aP, filterInputAttrs as aQ, VSelectionControl as aR, LoaderSlot as aS, IN_BROWSER as aT, VFadeTransition as aU, makeVCheckboxBtnProps as aV, VCheckboxBtn as aW, VMenu as aX, VList as aY, makeFormProps as aZ, createForm as a_, getDecimals as aa, createRange as ab, Ripple as ac, useElevation as ad, VScaleTransition as ae, keyValues as af, useRounded as ag, makeFocusProps as ah, makeVInputProps as ai, useFocus as aj, VInput as ak, VLabel as al, SUPPORTS_EYE_DROPPER as am, HSVtoCSS as an, parseColor as ao, deepEqual as ap, VIcon as aq, getContrast as ar, RGBtoCSS as as, consoleWarn as at, useTeamStore as au, VDivider as av, useTournamentStore as aw, VSelect as ax, VListItem as ay, VListItemTitle as az, VCardItem as b, makeSelectProps as b$, useDisplay as b0, parseQuery as b1, nuxtLinkDefaults as b2, hasProtocol as b3, resolveRouteObject as b4, joinURL as b5, navigateTo as b6, useNuxtApp as b7, useRuntimeConfig as b8, withTrailingSlash as b9, makePositionProps as bA, useBorder as bB, useLocation as bC, usePosition as bD, useToggleScope as bE, makeRouterProps as bF, useLink as bG, only as bH, focusChild as bI, defineNuxtRouteMiddleware as bJ, useSanctumUser as bK, abortNavigation as bL, createSimpleFunctional as bM, VCardActions as bN, makeDelayProps as bO, useRouter as bP, toPhysical as bQ, useDelay as bR, useTheme as bS, findChildrenWithProvide as bT, useSize as bU, useIntersectionObserver as bV, useVariant as bW, genOverlays as bX, useLocationStore as bY, VChipGroup as bZ, VResponsive as b_, withoutTrailingSlash as ba, isOn as bb, getObjectValueByPath as bc, getCurrentInstance as bd, wrapInArray as be, isEmpty as bf, makeBorderProps as bg, makeVariantProps as bh, defineFunctionalComponent as bi, consoleError as bj, makeDisplayProps as bk, makeLoaderProps as bl, VChip as bm, EventProp as bn, useLeaguesStore as bo, makeVFieldProps as bp, Intersect as bq, filterFieldProps as br, VField as bs, VCounter as bt, callEvent as bu, VProgressLinear as bv, humanReadableFileSize as bw, makeVOverlayProps as bx, VOverlay as by, makeLocationProps as bz, VCardTitle as c, makeVTextFieldProps as c0, makeTransitionProps as c1, useItems as c2, useForm as c3, useScrolling as c4, VVirtualScroll as c5, ensureValidVNode as c6, noop as c7, checkPrintable as c8, matchesSelector as c9, VDialogTransition as ca, useI18n as cb, breakpoints as cc, VCardText as d, entry$1 as default, VTextField as e, _export_sfc as f, useGlobalStore as g, useSanctumAuth as h, useRouter$1 as i, useSanctumClient as j, useToast as k, keys as l, makeComponentProps as m, makeTagProps as n, makeThemeProps as o, propsFactory as p, genericComponent as q, provideTheme as r, useRtl as s, useLocale as t, useCookie as u, useGroup as v, useRender as w, makeGroupItemProps as x, makeLazyProps as y, useGroupItem as z };
