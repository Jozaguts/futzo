import { hasInjectionContext, inject as inject$1, onScopeDispose, defineComponent as defineComponent$1, h, getCurrentInstance as getCurrentInstance$1, isVNode as isVNode$1, Comment, Fragment, shallowRef, watchEffect, readonly, warn as warn$1, ref, computed, unref, provide, capitalize as capitalize$1, camelize, createVNode, mergeProps, version as version$1, toRaw, isRef, isReactive, toRef, watch, Transition, toRefs, nextTick, withDirectives, resolveDirective, reactive, Text, resolveDynamicComponent, markRaw, vShow, Teleport, cloneVNode, createTextVNode, openBlock, createElementBlock, renderSlot, onServerPrefetch, defineAsyncComponent, onMounted, shallowReactive, Suspense, useSSRContext, effectScope, useAttrs, renderList, createBlock, normalizeClass, normalizeStyle, withCtx, TransitionGroup, onBeforeMount, onBeforeUpdate, createApp, getCurrentScope, onUnmounted, createCommentVNode, createElementVNode, normalizeProps, toDisplayString as toDisplayString$1, resolveComponent, createSlots, guardReactiveProps, onErrorCaptured, isReadonly, onBeforeUnmount, isShallow } from 'vue';
...
const onBeforeRouteLeave = (guard) => {
  const unsubscribe = useRouter$1().beforeEach((to2, from, next) => {
    if (to2 === from) {
      return;
    }
    return guard(to2, from, next);
  });
...
const useGlobalStore = defineStore("global", () => {
  ...
  const drawerWidth = ref(null | Number);
...
const useTournamentStore = defineStore("tournamentStore", () => {
  ...
  async function updateTournament(tournamentId2, formData) {
    return await useSanctumClient()(`api/v1/admin/tournaments/${tournamentId2}`, {
      method: "PUT",
      body: formData
    }).then(async (response2) => {
      return response2;
  ...
  async function getTournamentTypes() {
    const client = useSanctumClient();
    const response2 = await client("/api/v1/admin/tournaments/types");
    tournamentTypes.value = response2;
  }
  return {
    tournaments,
    tournament,
...
const _routes = [
  {
    ...
    component: () => import('./callback-B3N7i8yx.mjs').then((m) => m.default || m)
  },
  {
    name: "bienvenido",
    path: "/bienvenido",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./bienvenido-C5bWUqqy.mjs').then((m) => m.default || m)
  },
  {
    name: "calendario",
    path: "/calendario",
    component: () => import('./calendario-B8EuI2yE.mjs').then((m) => m.default || m)
  },
  {
    name: "configuracion",
    path: "/configuracion",
    component: () => import('./configuracion-rbWgd2dX.mjs').then((m) => m.default || m)
  },
  {
    name: "equipos",
    path: "/equipos",
    component: () => import('./index-CYjHFDkb.mjs').then((m) => m.default || m)
  },
  {
    name: "equipos-inscribir",
    path: "/equipos/inscribir",
    component: () => import('./inscribir-C98JgFH4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-IMW4Kvpa.mjs').then((m) => m.default || m)
  },
  {
    name: "jugadores",
    path: "/jugadores",
    component: () => import('./jugadores-QBn7rjKS.mjs').then((m) => m.default || m)
  },
  {
    name: "legales",
    path: "/legales",
    component: () => import('./legales-Czz-bEXF.mjs').then((m) => m.default || m)
  },
  {
    name: "liga-torneo",
    path: "/liga/:torneo()",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./_torneo_-2lSDdukr.mjs').then((m) => m.default || m)
  },
  {
    name: "liga",
    path: "/liga",
    component: () => import('./index-BmgYLB17.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-CVZbHsL5.mjs').then((m) => m.default || m)
  },
  {
    name: "mvp",
    path: "/mvp",
    component: () => import('./mvp-TyowzIRr.mjs').then((m) => m.default || m)
  },
  {
    name: "roles-permisos",
    path: "/roles-permisos",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./roles-permisos-DlqqbFGF.mjs').then((m) => m.default || m)
  },
  {
    name: "verify-email",
    path: "/verify-email",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BMd49KrJ.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-C0DoEzfB.mjs')
};
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./nuxt-icon-BuDW_oT6.mjs').then((r) => r["default"] || r.default || r));
...
const plugin_vfCt6Q18Tc = /* @__PURE__ */ defineNuxtPlugin(async () => {
  ...
  if (options.mode === "token" && !appConfig.tokenStorage) {
    ...
    const defaultStorage = ([__temp, __restore] = executeAsync(() => import('./cookieTokenStorage-uz7m1X4m.mjs')), __temp = await __temp, __restore(), __temp);
    updateAppConfig({
      sanctum: {
...
const layouts = {
  blank: () => import('./blank-BazuO11D.mjs').then((m) => m.default || m),
  default: () => import('./default-Ccx3nUfs.mjs').then((m) => m.default || m)
};
...
export { useLocale as $, createSimpleFunctional as A, propsFactory as B, makeComponentProps as C, makeDensityProps as D, makeDimensionProps as E, makeElevationProps as F, Gl as G, makeLocationProps as H, IconValue as I, makePositionProps as J, makeRoundedProps as K, makeTagProps as L, makeThemeProps as M, makeVariantProps as N, genericComponent as O, useProxiedModel as P, provideTheme as Q, useVariant as R, useDensity as S, useDimension as T, useElevation as U, VCard as V, useLocation as W, usePosition as X, useRounded as Y, useTextColor as Z, _export_sfc as _, VCardItem as a, VSpacer as a$, genOverlays as a0, VDefaultsProvider as a1, useRoute$1 as a2, isOn as a3, getObjectValueByPath as a4, getCurrentInstance as a5, deepEqual as a6, clamp as a7, wrapInArray as a8, isEmpty as a9, useFocus as aA, filterInputAttrs as aB, VInput as aC, filterFieldProps as aD, VField as aE, VCounter as aF, forwardRefs as aG, callEvent as aH, makeVOverlayProps as aI, useScopeId as aJ, getUid as aK, VOverlay as aL, VProgressLinear as aM, humanReadableFileSize as aN, useI18n as aO, useBorder as aP, makeVCheckboxBtnProps as aQ, parseQuery as aR, nuxtLinkDefaults as aS, hasProtocol as aT, resolveRouteObject as aU, joinURL as aV, navigateTo as aW, useRuntimeConfig as aX, withTrailingSlash as aY, withoutTrailingSlash as aZ, VCardActions as a_, makeBorderProps as aa, makeSizeProps as ab, useRtl as ac, useDisplay as ad, provideDefaults as ae, useResizeObserver as af, createRange as ag, useRender as ah, keyValues as ai, defineFunctionalComponent as aj, convertToUnit as ak, consoleError as al, makeDisplayProps as am, makeLoaderProps as an, useLoader as ao, useBackgroundColor as ap, LoaderSlot as aq, VCheckboxBtn as ar, EventProp as as, getPropertyFromItem as at, VDivider as au, useTheme as av, omit as aw, makeVInputProps as ax, makeVFieldProps as ay, Intersect as az, VCardTitle as b, VList as b0, useAsyncData as b1, keys as b2, useGroup as b3, makeGroupItemProps as b4, makeLazyProps as b5, useGroupItem as b6, useSsrBoot as b7, useLazy as b8, MaybeTransition as b9, ne$1 as bA, VExpandTransition as bB, useToggleScope as bC, makeRouterProps as bD, useLink as bE, makeDelayProps as bF, useRouter as bG, toPhysical as bH, useDelay as bI, VDialogTransition as bJ, eagerComputed as bK, findChildrenWithProvide as bL, makeVBtnProps as ba, animate as bb, standardEasing as bc, makeVSlideGroupProps as bd, VSlideGroup as be, isObject as bf, makeSelectProps as bg, makeVTextFieldProps as bh, makeTransitionProps as bi, useItems as bj, useForm as bk, useScrolling as bl, VMenu as bm, VVirtualScroll as bn, ensureValidVNode as bo, noop$1 as bp, matchesSelector as bq, makeFormProps as br, createForm as bs, breakpoints as bt, makeFocusProps as bu, only as bv, focusChild as bw, defineNuxtRouteMiddleware as bx, useSanctumUser as by, abortNavigation as bz, VCardText as c, VTextField as d, entry$1 as default, VBtn as e, useGlobalStore as f, useSanctumAuth as g, useRouter$1 as h, useSanctumClient as i, defineStore as j, VSelect as k, VChip as l, useTournamentStore as m, useAuthStore as n, onBeforeRouteLeave as o, VIcon as p, VProgressCircular as q, VAvatar as r, storeToRefs as s, VImg as t, useCookie as u, VCardSubtitle as v, __nuxt_component_0$1 as w, VListItem as x, VListItemTitle as y, VListItemSubtitle as z };
