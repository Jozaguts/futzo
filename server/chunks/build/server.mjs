import { hasInjectionContext, inject as inject$1, version as version$1, defineComponent as defineComponent$1, h, getCurrentInstance as getCurrentInstance$1, isVNode as isVNode$1, Comment, Fragment, warn as warn$1, ref, computed, unref, provide, capitalize as capitalize$1, camelize, createVNode, mergeProps, watch, onScopeDispose, toRaw, readonly, useSSRContext, defineAsyncComponent, Transition, toRefs, isRef, toRef, shallowRef, nextTick, withDirectives, resolveDirective, reactive, Text, resolveDynamicComponent, markRaw, vShow, Teleport, cloneVNode, createTextVNode, onMounted, shallowReactive, Suspense, watchEffect, effectScope, onServerPrefetch, TransitionGroup, onBeforeMount, onBeforeUpdate, createApp, getCurrentScope, resolveComponent, openBlock, createElementBlock, createBlock, createSlots, withCtx, renderSlot, toDisplayString as toDisplayString$1, normalizeProps, guardReactiveProps, createCommentVNode, createElementVNode, renderList, onErrorCaptured, isReadonly, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, i as baseURL, k as klona, j as parse$1, l as getRequestHeader, m as getRequestURL, n as defu, s as sanitizeStatusCode, o as destr, q as isEqual$2, r as setCookie, t as getCookie, v as deleteCookie, w as getContext, x as createHooks, c as createError$1, y as defuFn, z as toRouteMatcher, A as createRouter$1, B as createConsola, C as getRequestHeaders, F as FetchError, D as splitCookiesString, E as appendResponseHeader } from '../nitro/nitro.mjs';
...
function createIcons(options) {
  ...
  const defaultSet2 = (options == null ? void 0 : options.defaultSet) ?? "mdi";
  if (defaultSet2 === "mdi" && !sets.mdi) {
    sets.mdi = mdi;
  }
  return mergeDeep({
    defaultSet: defaultSet2,
    sets,
    aliases: {
      ...aliases$1,
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--10abc89e": _ctx.backgroundColor,
        "--64bc773f": _ctx.color
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "headless" }, _attrs, _cssVars))} data-v-1b747a0f>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: _ctx.typeIcon,
        size: "38",
        class: "icon"
      }, null, _parent));
      _push(`<p class="headlessTitle" data-v-1b747a0f>${ssrInterpolate(_ctx.msg)}</p><button class="headlessClose" data-v-1b747a0f>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: _ctx.closeIcon,
        size: "38"
      }, null, _parent));
      _push(`</button><p class="headlessDescription" data-v-1b747a0f>${ssrInterpolate(_ctx.description)}</p></div>`);
    };
  }
});
...
const Notification = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1b747a0f"]]);
const colors = {
  success: {
    color: "#4CA30D",
    background: "#F3FEE7"
...
const useAuthStore = defineStore("authStore", () => {
  ...
  const image = computed(() => {
    var _a2;
    return (_a2 = user.value) == null ? void 0 : _a2.image;
  });
  ...
  const updatePassword = (updateUserPasswordForm) => {
    ...
    client(`api/v1/admin/profile/${updateUserPasswordForm.id}/password`, {
      ...
      var _a2;
      const message = ((_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.message) || "No se pudo actualizar la contraseña. Verifica tu información e inténtalo de nuevo.";
  ...
  const updateImage = async (image2) => {
    ...
    client(`api/v1/admin/profile/${(_a2 = user.value) == null ? void 0 : _a2.id}/image`, {
      method: "POST",
      body: formData
    }).then(async () => {
      const { refreshIdentity } = useSanctumAuth();
      ...
      var _a3;
      const message = ((_a3 = error == null ? void 0 : error.data) == null ? void 0 : _a3.message) || "No se pudo actualizar tu imagen. Verifica tu información e inténtalo de nuevo.";
  ...
  const appendData = (prefix, data) => {
    for (const key in data) {
      if (data[key] instanceof File) {
        ...
        const date2 = data[key].toISOString().split("T")[0];
        form.append(`${prefix}[${key}]`, date2);
...
const useTournamentStore = defineStore("tournamentStore", () => {
  ...
  async function fetchTournamentsByLeagueId() {
    ...
    const { data } = await client(
      `/api/v1/admin/leagues/${(_b = (_a2 = user.value) == null ? void 0 : _a2.league) == null ? void 0 : _b.id}/tournaments`
    );
  ...
  const createTeam = async () => {
    ...
    await client("/api/v1/admin/teams", {
      ...
      toast(
        ...
        ((_a2 = error.data) == null ? void 0 : _a2.message) ?? "No se pudo crear el equipo. Verifica tu información e inténtalo de nuevo."
      );
    });
  };
  const updateTeam = async (teamId2) => {
    ...
    await client(`/api/v1/admin/teams/${teamId2}`, {
      ...
      toast(
        ...
        ((_a2 = error.data) == null ? void 0 : _a2.message) ?? "No se pudo actualizar el equipo. Verifica tu información e inténtalo de nuevo."
      );
    });
  };
  const prepareForm2 = () => {
...
const usePlayerStore = defineStore("playerStore", () => {
  ...
  const createPlayer = async () => {
    ...
    await client("/api/v1/admin/players", {
      ...
      toast(
        ...
        ((_b = error.data) == null ? void 0 : _b.message) ?? "No se pudo crear al jugador. Verifica tu información e inténtalo de nuevo."
      );
    });
  };
  ...
  const importPlayersHandler = async (file) => {
    const client = useSanctumClient();
    const formData = new FormData();
    ...
    await client("/api/v1/admin/players/import", {
      ...
      toast(
        "error",
        "Error importar",
        ((_b = error.data) == null ? void 0 : _b.message) ?? "No se pudo importar el documento. Verifica su información e inténtalo de nuevo."
      );
    });
  };
  const steps = ref({
...
const _routes = [
  {
    ...
    component: () => import('./callback-DtmZ-raa.mjs')
  },
  {
    name: "bienvenido",
    path: "/bienvenido",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./bienvenido-B4zllSaO.mjs')
  },
  {
    name: "configuracion",
    path: "/configuracion",
    component: () => import('./configuracion-DVv-FHh3.mjs')
  },
  {
    name: "equipos-equipo",
    path: "/equipos/:equipo()",
    component: () => import('./_equipo_-CMwhu8wW.mjs')
  },
  {
    name: "equipos",
    path: "/equipos",
    component: () => import('./index-BrkjQfNx.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-XvxODMw9.mjs')
  },
  {
    name: "jugadores",
    path: "/jugadores",
    component: () => import('./index-Ze8vD3rr.mjs')
  },
  {
    name: "legales",
    path: "/legales",
    component: () => import('./legales-C9hVUqri.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-CKVfHiE7.mjs')
  },
  {
    name: "mvp",
    path: "/mvp",
    component: () => import('./mvp-Cida8kmF.mjs')
  },
  {
    name: "torneos-torneo-calendario",
    path: "/torneos/:torneo()/calendario",
    component: () => import('./calendario-gAbK2GoV.mjs')
  },
  {
    name: "torneos-torneo",
    path: "/torneos/:torneo()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-DzPuQdIa.mjs')
  },
  {
    name: "torneos",
    path: "/torneos",
    component: () => import('./index-C2d6HebX.mjs')
  },
  {
    name: "verify-email",
    path: "/verify-email",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DKJ0i6KI.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-rBu6abGz.mjs')
};
...
async function setupDefaultTokenStorage(nuxtApp, logger) {
  ...
  const defaultStorage = await import('./cookieTokenStorage-BCvjwe-h.mjs');
...
const plugin_vfCt6Q18Tc = /* @__PURE__ */ defineNuxtPlugin(async (_nuxtApp) => {
  let __temp, __restore;
...
function findBrowserLocale(locales, browserLocales, { matcher = DefaultBrowserLocaleMatcher, comparer = DefaultBrowerLocaleComparer } = {}) {
  ...
  for (const l2 of locales) {
    const { code: code2 } = l2;
    const language = l2.language || code2;
...
function getDomainFromLocale(localeCode) {
  ...
  const domain = ((_b = (_a2 = config == null ? void 0 : config.locales) == null ? void 0 : _a2[localeCode]) == null ? void 0 : _b.domain) || (lang == null ? void 0 : lang.domain) || ((_e2 = (_d = (_c2 = config == null ? void 0 : config.locales) == null ? void 0 : _c2[localeCode]) == null ? void 0 : _d.domains) == null ? void 0 : _e2.find((v) => v === host)) || ((_f = lang == null ? void 0 : lang.domains) == null ? void 0 : _f.find((v) => v === host));
  if (domain) {
...
const aliases = {
  ...
  test: "svgNuxtIcon:ball"
};
function nuxtIcon(css) {
  const component = __nuxt_component_1$1;
  const mode = "svg";
  return {
...
const custom_icons_FSKr5T2Qqs = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
function wn({ props: n }) {
  const t = getSupportedRegionCodes(), o = ref({}), a = ref(0), u = ref([]), C = ref([]), $ = computed(() => n.preferCountries.map(b)), s = computed(() => n.includeCountries.map(b)), p = computed(() => n.excludeCountries.map(b));
  watchEffect(() => {
    const y = {}, G = [], h2 = [];
    ...
    }), G.sort((I, c) => $.value.indexOf(I.iso2) - $.value.indexOf(c.iso2)), o.value = y, u.value = G, C.value = h2, a.value = G.length + h2.length, a.value || console.error('[v-phone-input] resulting countries from "allCountries", "includeCountries" and "excludeCountries" must be a non-empty list');
  });
  const m = computed(() => {
  ...
  return {
    ...
    setCountryPreference: (y) => {
      v.value = false, kn(n.countryGuesser) && n.countryGuesser.setPreference(y);
    },
    guessCountry: async () => {
      if (!n.guessCountry)
        return;
...
function Jn({ props: n, country: t, example: o }) {
  const a = (f, V) => typeof f == "function" ? f(V) : f, u = computed(() => ({ country: t.value, example: o.value })), C = computed(() => a(n.label, u.value)), $ = computed(() => a(n.ariaLabel, u.value)), s = computed(() => ({
    ...u.value,
    label: C.value || $.value
...
const Y = [
  ...
  setup(n, { attrs: t, emit: o, slots: a }) {
    const {
      ...
      guessCountry: v
    } = wn({ props: n }), N = ref(null), f = ref(null), { namespacedSlots: V } = zn(a, ["country"]), { countryIconComponent: y } = Wn({ props: n }), { countrySelectComponent: G } = Yn({ props: n }), h2 = ref(false), I = ref([]), c = ref(n.country), d = ref(n.modelValue || ""), M = ref({ number: { input: "" } }), O = (e) => Object.keys(t).reduce((i, L) => e(L) ? { ...i, [L]: t[L] } : i, {}), dn = computed(() => ({
      ...O((e) => Y.indexOf(e) !== -1),
      ...n.wrapperProps
    })), yn = computed(() => ({
      ...G.value.props,
      ...
      ...O((e) => Y.indexOf(e) === -1),
      ...n.phoneProps
    })), $n = computed(() => p(n.defaultCountry) || m.value), E = computed(() => p(c.value) || $n.value), Sn = computed(() => [...C.value.map((i) => ({ ...i, preferred: true })), ...$.value]), U = (e) => $l(e, n.displayFormat), pn = computed(() => n.example !== void 0 ? typeof n.example == "function" ? n.example(E.value) : n.example : U(Sl(E.value.iso2))), Mn = computed(() => {
      var i;
    ...
    const fn = () => {
      ...
      var i, L;
      const e = ((i = M.value.number) == null ? void 0 : i.e164) || ((L = M.value.number) == null ? void 0 : L.input) || "";
      e !== n.modelValue && o("update:modelValue", e);
    };
    watch(c, hn), watch(d, X), watch(M, An, { deep: true });
    const Bn = async () => {
      if (c.value)
        return;
      if (u.value === 1) {
...
const plugins = [
  ...
  plugin_tMGwffvjBc,
  plugin,
  custom_icons_FSKr5T2Qqs,
  vuetify_input_number_LSnmmtDzvc,
  vuetify_nuxt_plugin_server_h6zVy7S406
];
const layouts = {
  blank: defineAsyncComponent(() => import('./blank-BkLkvwJU.mjs')),
  default: defineAsyncComponent(() => import('./default-B1Af0Old.mjs'))
};
...
export { useResizeObserver as $, useSsrBoot as A, useLazy as B, convertToUnit as C, omit as D, useTextColor as E, forwardRefs as F, animate as G, standardEasing as H, useProxiedModel as I, makeVSlideGroupProps as J, makeDensityProps as K, useDensity as L, MaybeTransition as M, useBackgroundColor as N, useScopeId as O, provideDefaults as P, VSlideGroup as Q, isObject as R, useAuthStore as S, VAvatar as T, VImg as U, VCard as V, VCardSubtitle as W, Gl as X, defineComponent as Y, clamp as Z, __nuxt_component_1$1 as _, useRequestURL as a, IconValue as a$, getEventCoordinates as a0, HSVtoHex as a1, has as a2, HSVtoRGB as a3, HSVtoHSL as a4, RGBtoHSV as a5, HSLtoHSV as a6, HexToHSV as a7, makeRoundedProps as a8, makeElevationProps as a9, getUid as aA, getPropertyFromItem as aB, useDashboardStore as aC, useRoute$1 as aD, usePlayerStore as aE, usePositionsStore as aF, makeGroupProps as aG, makeVCheckboxBtnProps as aH, filterInputAttrs as aI, VCheckboxBtn as aJ, makeFormProps as aK, createForm as aL, parseQuery as aM, nuxtLinkDefaults as aN, hasProtocol as aO, resolveRouteObject as aP, joinURL as aQ, navigateTo as aR, useNuxtApp as aS, useRuntimeConfig as aT, withTrailingSlash as aU, withoutTrailingSlash as aV, isOn as aW, getObjectValueByPath as aX, getCurrentInstance as aY, wrapInArray as aZ, isEmpty as a_, getDecimals as aa, createRange as ab, Ripple as ac, useElevation as ad, VScaleTransition as ae, keyValues as af, useRounded as ag, makeFocusProps as ah, makeVInputProps as ai, useFocus as aj, VInput as ak, VLabel as al, SUPPORTS_EYE_DROPPER as am, HSVtoCSS as an, parseColor as ao, deepEqual as ap, VIcon as aq, getContrast as ar, RGBtoCSS as as, consoleWarn as at, useTeamStore as au, VDivider as av, useTournamentStore as aw, VSelect as ax, VListItem as ay, VListItemTitle as az, VCardItem as b, useSize as b$, makeBorderProps as b0, makeSizeProps as b1, makeVariantProps as b2, useDisplay as b3, defineFunctionalComponent as b4, consoleError as b5, makeDisplayProps as b6, makeLoaderProps as b7, useLoader as b8, LoaderSlot as b9, makeDimensionProps as bA, makeLocationProps as bB, makePositionProps as bC, useBorder as bD, useDimension as bE, useLocation as bF, usePosition as bG, humanReadableFileSize as bH, useI18n as bI, VExpandTransition as bJ, useToggleScope as bK, makeRouterProps as bL, useLink as bM, breakpoints as bN, only as bO, focusChild as bP, defineNuxtRouteMiddleware as bQ, useSanctumUser as bR, abortNavigation as bS, createSimpleFunctional as bT, VCardActions as bU, makeDelayProps as bV, useRouter as bW, toPhysical as bX, useDelay as bY, useTheme as bZ, findChildrenWithProvide as b_, VChip as ba, EventProp as bb, makeVFieldProps as bc, Intersect as bd, filterFieldProps as be, VField as bf, VCounter as bg, callEvent as bh, makeSelectProps as bi, makeVTextFieldProps as bj, makeTransitionProps as bk, useItems as bl, useForm as bm, useScrolling as bn, VMenu as bo, VList as bp, VVirtualScroll as bq, ensureValidVNode as br, VDefaultsProvider as bs, noop as bt, checkPrintable as bu, matchesSelector as bv, makeVOverlayProps as bw, VDialogTransition as bx, VOverlay as by, VProgressLinear as bz, VCardTitle as c, useIntersectionObserver as c0, useVariant as c1, genOverlays as c2, VCardText as d, entry$1 as default, VTextField as e, _export_sfc as f, useGlobalStore as g, useSanctumAuth as h, useRouter$1 as i, useSanctumClient as j, useToast as k, keys as l, makeComponentProps as m, makeTagProps as n, makeThemeProps as o, propsFactory as p, genericComponent as q, provideTheme as r, useRtl as s, useLocale as t, useCookie as u, useGroup as v, useRender as w, makeGroupItemProps as x, makeLazyProps as y, useGroupItem as z };
