import { computed, createVNode, Fragment, ref, watch, nextTick, toRef, mergeProps, useSSRContext, defineComponent, watchEffect, withCtx, unref, createTextVNode, isRef, toDisplayString, openBlock, createBlock, renderList, withAsyncContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderClass } from 'vue/server-renderer';
import { p as propsFactory, q as genericComponent, aA as getUid, aB as getPropertyFromItem, w as useRender, E as useTextColor, aC as useDashboardStore, aD as useRoute$1, i as useRouter$1, k as useToast, V as VCard, c as VCardTitle, b as VCardItem, au as useTeamStore, _ as __nuxt_component_1$1 } from './server.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$7 } from './app-bar-4n5zyiNx.mjs';
import { storeToRefs } from 'pinia';
import { V as VItemGroup, a as VItem } from './VItem-DP3CX-WZ.mjs';
...
import { g as getHeaders, _ as _sfc_main$8 } from './headers-table-Dwx7nOYp.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useTeamStore().getTeams("desc", 5)), await __temp, __restore();
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_1$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard-game-container" }, _attrs))}><div class="dashboard-teams"><div class="dashboard-team-local"><img src="https://placehold.co/50x50" alt="team logo" class="dashboard-logo"><span class="dashboard-team_name">Equipo 1</span></div><div class="dashboard-vs-container"><div class="dashboard-vs">vs</div></div><div class="dashboard-team-away"><img src="https://placehold.co/50x50" alt="team logo" class="dashboard-logo"><span class="dashboard-team_name">Equipo 1</span></div></div><div class="dashboard-data"><span class="dashboard-date">24/06/2024</span><span class="dashboard-hour">10:00</span><span class="dashboard-field">Campo 1</span></div><div class="dashboard-btn-container">`);
...
//# sourceMappingURL=index-XvxODMw9.mjs.map
