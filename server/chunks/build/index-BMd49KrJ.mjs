import { _ as _sfc_main$3 } from './Logo-CrZVdvyd.mjs';
...
import { B as propsFactory, E as makeDimensionProps, bu as makeFocusProps, bv as only, ay as makeVFieldProps, O as genericComponent, T as useDimension, aA as useFocus, P as useProxiedModel, $ as useLocale, ae as provideDefaults, ah as useRender, aB as filterInputAttrs, aE as VField, aL as VOverlay, q as VProgressCircular, a2 as useRoute$1, bw as focusChild, V as VCard, a as VCardItem, b as VCardTitle, v as VCardSubtitle, c as VCardText, e as VBtn, h as useRouter$1, _ as _export_sfc, i as useSanctumClient, f as useGlobalStore } from './server.mjs';
  ...
  setup(__props) {
    ...
    const verifyEmail = (code) => {
      ...
      client(`/verify-email`, {
        ...
        var _a2;
        useGlobalStore().showSuccessNotification({ message: (_a2 = response == null ? void 0 : response.message) != null ? _a2 : "Correo verificado" });
        currentComponent.value = "VerifiedCard";
      }).catch((error) => {
        var _a3;
        var _a2;
        const errorMessage = (_a3 = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.message) != null ? _a3 : "Ha ocurrido un error";
...
//# sourceMappingURL=index-BMd49KrJ.mjs.map
