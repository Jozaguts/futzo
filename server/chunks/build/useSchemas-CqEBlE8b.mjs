import { u as useForm } from './vee-validate-DdIKuPJn.mjs';
import * as yup from 'yup';
import { boolean } from 'yup';
import { reactive } from 'vue';
import { cb as useI18n } from './server.mjs';
...
function useSchemas(schemaNAme, initialValues = {}) {
  ...
  const { defineField, handleSubmit, resetForm, validate, setValues, meta } = useForm({
...
//# sourceMappingURL=useSchemas-CqEBlE8b.mjs.map
