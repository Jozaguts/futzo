import { useSSRContext, defineComponent, ref, withCtx, createVNode, unref, isRef, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, mergeProps, renderSlot } from 'vue';
import { ao as useRoute$1, a5 as VIcon, ab as VDivider, V as VCard, c as VCardText, av as VCardActions, d as VTextField, i as useSanctumClient, aw as useDisplay, a as VCardItem, b as VCardTitle, ax as VSpacer, n as VCardSubtitle, e as VBtn, ay as VList, ae as VListItem, af as VListItemTitle, az as useAsyncData } from './server.mjs';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
import { _ as _sfc_main$2$1, a as _sfc_main$4 } from './app-bar-vuUpVYZ5.mjs';
...
import { V as VTabs, a as VTab, d as VWindow, e as VWindowItem } from './VTabs-58Xred3X.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                      ...
                                      _push6(ssrRenderComponent(VTab, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(` ${ssrInterpolate(tab.title)}`);
                                          } else {
                                            return [
                                              createVNode(VIcon, {
                                                size: "20",
                              ...
                              _push5(ssrRenderComponent(VWindow, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VWindowItem, { value: "roles-permissions" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
...
//# sourceMappingURL=roles-permisos-nSrpJDx2.mjs.map
