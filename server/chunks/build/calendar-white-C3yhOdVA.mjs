...
const calendarWhite = { render() {
  return h(NuxtIcon, { icon: { render }, name: "calendar-white" });
} };

export { calendarWhite as default, render };
//# sourceMappingURL=calendar-white-C3yhOdVA.mjs.map
