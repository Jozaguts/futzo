import { createVNode, toRef, shallowRef, computed, ref, watchEffect, mergeProps, Fragment, defineComponent, useSSRContext, withCtx, renderSlot, watch, unref, toDisplayString, openBlock, createBlock, createCommentVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import { p as propsFactory, m as makeComponentProps, n as makeTagProps, q as genericComponent, w as useRender, bg as makeBorderProps, a9 as makeElevationProps, a8 as makeRoundedProps, o as makeThemeProps, N as useBackgroundColor, bB as useBorder, ad as useElevation, ag as useRounded, r as provideTheme, s as useRtl, P as provideDefaults, U as VImg, aM as VDefaultsProvider, C as convertToUnit, aI as VExpandTransition, I as useProxiedModel, bE as useToggleScope, A as useSsrBoot, bF as makeRouterProps, bG as useLink, E as useTextColor, aJ as IconValue, K as makeDensityProps, L as useDensity, aq as VIcon, Z as clamp, aD as useRoute$1, S as useAuthStore, _ as __nuxt_component_0$1 } from './server.mjs';
import { m as makeLayoutItemProps, u as useLayoutItem } from './layout-DtoiCxLB.mjs';
    ...
    useRender(() => {
      return createVNode(props.tag, {
        ...
        default: () => {
          var _a2, _b2;
          var _a, _b;
          return [!link.isLink.value ? (_a2 = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _a2 : props.title : createVNode("a", mergeProps({
...
//# sourceMappingURL=AppBar-VUGc6BDC.mjs.map
