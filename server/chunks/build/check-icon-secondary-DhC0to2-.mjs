...
const checkIconSecondary = { render() {
  return h(NuxtIcon, { icon: { render }, name: "check-icon-secondary" });
} };

export { checkIconSecondary as default, render };
//# sourceMappingURL=check-icon-secondary-DhC0to2-.mjs.map
