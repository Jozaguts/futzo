...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"facebook-domain-verification","content":"0qihdsq3uqi5n4uaim0ao378p6e5xv"}],"link":[{"key":"mdi","rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/@mdi/font@5.x/css/materialdesignicons.min.css","type":"text/css","crossorigin":"anonymous"}],"style":[],"script":[{"src":"https://maps.googleapis.com/maps/api/js?key=AIzaSyCEQ_vXTkXUIxE-exwES14KvkoGaAHOGFQ&libraries=places","async":true,"defer":true}],"noscript":[]};
