...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"src":"https://maps.googleapis.com/maps/api/js?key=AIzaSyCEQ_vXTkXUIxE-exwES14KvkoGaAHOGFQ&libraries=places","async":true,"defer":true}],"noscript":[]};
