import { getCurrentInstance as getCurrentInstance$1, version as version$1, toRef, isRef, createVNode, mergeProps, inject as inject$1, toRefs, Transition, ref, computed, watch, nextTick, Text, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment as Fragment$1, reactive, capitalize, h, onUpdated, unref, defineComponent as defineComponent$1, camelize, toRaw, readonly, shallowRef, TransitionGroup, resolveDynamicComponent, cloneVNode, effectScope, warn, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, markRaw, withCtx, Suspense } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [{ "rel": "stylesheet", "href": "/loader.css" }], "style": [], "script": [{ "innerHTML": `
      ...
      } (document, 'script', 'facebook-jssdk'));` }], "noscript": [] };
...
const layouts = {
  blank: () => import('./blank-94937d80.mjs').then((m) => m.default || m),
  default: () => import('./default-74996443.mjs').then((m) => m.default || m)
};
...
const LazyIcon = /* @__PURE__ */ defineAsyncComponent(() => import(
  './Icon-f1b99edd.mjs'
  /* webpackChunkName: "components/icon" */
).then((c) => c.default || c));
const LazyIconCSS = /* @__PURE__ */ defineAsyncComponent(() => import(
  './IconCSS-d5f031ce.mjs'
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-2e8d5ea2.mjs').then((m) => m.default || m)
  },
  {
    name: "legales",
    path: "/legales",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./legales-c4949e03.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./login-15b0c0aa.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./register-64bd1927.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  guest: () => import('./guest-7eb3817f.mjs')
};
...
function mounted$3(el, binding) {
  ...
  keys(handlers2).forEach((eventName) => {
    target.addEventListener(eventName, handlers2[eventName], options);
  });
}
function unmounted$3(el, binding) {
  ...
  keys(handlers2).forEach((eventName) => {
    target.removeEventListener(eventName, handlers2[eventName]);
  });
...
const VVirtualScroll = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function handleItemResize(index2, height) {
      ...
      sizes[index2] = height;
      sizeMap.set(props.items[index2], height);
    }
    function calculateOffset(index2) {
      return sizes.slice(0, index2).reduce((curr, value) => curr + (value || itemHeight.value), 0);
    }
    ...
    watch(() => props.items.length, () => {
      ...
      sizeMap.forEach((height, item) => {
        const index2 = props.items.indexOf(item);
        if (index2 === -1) {
          sizeMap.delete(item);
        } else {
          sizes[index2] = height;
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-9d159211.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-8fceb4de.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useState as a, useTheme as b, createError as c, useRuntimeConfig as d, entry$1 as default, defineNuxtRouteMiddleware as e, useLocalStorage as f, useHead as g, useRouter$1 as h, navigateTo as n, useNuxtApp as u };
